...
inline Vitrae::DetailFormVector generateModelSilhouette(Vitrae::ComponentRoot &root, const Vitrae::Model &model)
{
...
inline void setupModelSilhouetteGenerator(Vitrae::ComponentRoot &root)
{
    root.getComponent<Vitrae::FormGeneratorCollection>()[Vitrae::Purposes::silhouetting] = generateModelSilhouette;
}
